...
function getProfileTemplate(person) {
  ...
  if (person.liked == true) {
    ...
    imagesrc = "data:image/svg+xml;base64,"
  }
  ...
  var template = `
    <div class="row" id="${person.id}">
      ...
      <div class=text-center>
        ...
        <p>${person.text} </p>
        <img id="icon" src=${imagesrc} height="25px" onclick="updateLikes('${person.id}')">  <img id="icon2" src=${imagesrc} height="25px" onclick="updateLikes('${person.id}')">
        <p id="counter">${person.likes}</p><p id="counter2">${person.dislikes}</p>
...
function updateDislikes(personid) {
  ...
  if (youth_data[personid].disliked == false){
    ...
    counter.innerHTML = youth_data[personid].dislikes;
