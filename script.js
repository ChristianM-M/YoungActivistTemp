var youth_data = {
  ...
  Tiffany_Dena_Loftin: {
    ...
    liked: false,
    disliked: false,
    text: "<p>I am still motivated and focused on fighting for my people who are victims of state violence. State violence shows up in different but real ways. When my people don’t have access to clean water or healthy food, that is violence. When my people are denied health care because it is unaffordable, I see that as strategic violence. When kids can’t learn in the classroom because the schools are underfunded or aren’t taught real history of this country, that is mental violence. It shows up in more ways, in addition to police brutality and discrimination in the courtroom and I am fighting to end all of it. Why? Because I believe real freedom is possible.</p>"
  },
  ...
  Courtney_Roberts: {
    ...
    twitter: "",
    instagram: "https://www.instagram.com/everydayblackgirl/",
    likes: 0,
    dislikes: 0,
    liked: false,
    disliked: false,
...
function getGridTemplate(person) {
  ...
  var template = `
    <div class="hand text-center" onclick="processClick('${person.id}')" id="${person.id}">

    <img src="${person.imageURL}" alt="${person.name}" class="img-fluid profilePic">
    <h5>${person.name} </h5>
    <a href="${person.twitter}"><img src="https://cdn2.iconfinder.com/data/icons/minimalism/512/twitter.png" height="25px"></a><a href="${person.instagram}"><img src="data:image/svg+xml;base64," height="25px"></a>
    <p>${person.age}, ${person.location}</p>
    </div>
  `
  return template
}
...
function getProfileTemplate(person) {
  ...
  if (person.liked == true) {
    imagesrc = "data:image/svg+xml;base64,"
  } else {
    imagesrc = "data:image/svg+xml;base64,"
  }

  if (person.disliked == true) {
    imagesrc2 = "data:image/svg+xml;base64,"
  } else {
    imagesrc2 = "data:image/svg+xml;base64,"
  }


  var template = `
    <div class="row" id="${person.id}">
      <div class="col-6 offset-3">
      <div class=text-center>
        <img onclick="processClick('${person.id}')" src="${person.imageURL}" alt="${person.name}" class="img-fluid">
        <h1>${person.name}, ${person.age}</h1>
        <h2>${person.location}</h2>
        <a href="https://twitter.com/${person.twitter}"><img src="https://cdn2.iconfinder.com/data/icons/minimalism/512/twitter.png" height="35px"></a><a href="${person.instagram}"><img src="data:image/svg+xml;base64," height="35px"></a>
        </div>
        <p>${person.text} </p>
        <div class="row">
          <div class="col-1">
            <img id="icon" src=${imagesrc} height="25px" onclick="updateLikes('${person.id}')">
            <p id="counter">${person.likes}</p>
          </div>
          <div class="col-1">
            <img id="icon2" src=${imagesrc2} height="25px" onclick="updateDislikes('${person.id}')">
            <p id="counter2">${person.dislikes}</p>
          </div>
        </div>

        <button type button class="hand btn btn-dark" onclick="goBack()"><h4>BACK</h4></button>
      </div>
    </div>
  `
  return template
...
function updateLikes(personid) {
  ...
  if (youth_data[personid].liked == false){
    youth_data[personid].likes = youth_data[personid].likes + 1;
    icon.src = "data:image/svg+xml;base64,";
    counter.innerHTML = youth_data[personid].likes;
    youth_data[personid].liked = true
  }
  else {
    youth_data[personid].likes = youth_data[personid].likes - 1;
    icon.src = "data:image/svg+xml;base64,";
    youth_data[personid].liked = false
    counter.innerHTML = youth_data[personid].likes;
  }
}

function updateDislikes(personid) {
  var icon2 = document.getElementById('icon2');
  var counter2 = document.getElementById('counter2');

  if (youth_data[personid].disliked == false){
    youth_data[personid].dislikes = youth_data[personid].dislikes + 1;
    icon2.src = "data:image/svg+xml;base64,";
    counter2.innerHTML = youth_data[personid].dislikes;
    youth_data[personid].disliked = true
  }
  else {
    youth_data[personid].dislikes = youth_data[personid].dislikes - 1;
    icon2.src = "data:image/svg+xml;base64,";
    youth_data[personid].disliked = false
    counter2.innerHTML = youth_data[personid].dislikes;
  }
}
