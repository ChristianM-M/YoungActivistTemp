var youth_data = {
  Celeste_Aguilar: {
   ...
   question: "<h5>Are You Good?</h5>",
   choices: "<button type="button" class="btn btn-warning">Yes</button> <button type="button" class="btn btn-warning">No</button>"
  },
  Hamdia_Ahmed: {
   id: "Hamdia_Ahmed",
   name: "Hamdia Ahmed",
...
function getGridTemplate(person){
  ...
  var template = `
    ...
    <h5>${person.name} </h5>
    <a href="${person.twitter}"><img src="https://cdn2.iconfinder.com/data/icons/minimalism/512/twitter.png" height="25px"></a><a href="${person.instagram}"><img src="https://www.google.com/url?sa=i&rct=j&q=&esrc=s&source=images&cd=&cad=rja&uact=8&ved=2ahUKEwih1-iY573bAhWnjlQKHcqdC6UQjRx6BAgBEAU&url=http%3A%2F%2Fpahangfa.com%2Finstagram-logo-white%2F&psig=AOvVaw34Mf7kHNflz9v7GPKHk_Td&ust=1528332083861037" height="25px"></a>
